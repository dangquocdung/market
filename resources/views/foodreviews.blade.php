...
@section('content')
    ...
    <!-- Tabs -->
        ...
        <ul class="nav nav-tabs tab-nav-right" role="tablist">
            ...
            @if ($userinfo->getUserPermission("Food::Reviews::Create"))
                                    ...
                                    <table id="data_table" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        @foreach($idata as $key => $data)
                                            <tr id="tr{{$data->id}}">
                                                ...
                                                <td>
                                                @foreach($ifoods as $key => $idata)
                                                    @if ($idata->id == $data->food)
                                                        {{$idata->name}}
                                                    @endif
                                                @endforeach
                                                </td>
                                                ...
                                                <td>
                                                    @if ($userinfo->getUserPermission("Food::Reviews::Edit"))
                                                    ...
                                                    @endif
                                                    @if ($userinfo->getUserPermission("Food::Reviews::Delete"))
        ...
        <form id="formcreate" method="post" action="{{url('foodreviewsadd')}}"  >
            ...
            <div class="row clearfix">
                <div class="col-md-2 form-control-label">
                    <label for="name"><h4>{{$lang->get(137)}}</h4></label>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-2 form-control-label">
                    <label><h4>{{$lang->get(138)}}</h4></label>
                </div>
                <div class="col-md-4">
                    <div class="form-group form-group-lg form-float">
                        <div class="form-line">
                            <select name="food" id="food" class="form-control bs-searchbox" style="font-size: 26px  !important; ">
                                <option value="-1" style="font-size: 18px  !important;">{{$lang->get(114)}}</option>
                                @foreach($ifoods as $key => $data)
            ...
            <div class="row clearfix">
                <div class="col-md-2 form-control-label">
                    <label><h4>{{$lang->get(136)}}</h4></label>
                </div>
                <div class="col-md-4">
                    <div class="form-group form-group-lg form-float">
                        <div class="form-line">
            ...
            <div class="row clearfix">
                <div class="col-md-2 form-control-label">
                    <label><h4>{{$lang->get(140)}}</h4></label>
                </div>
                <div class="col-md-10">
    ...
    <!-- Tab Edit -->
        ...
        <div role="tabpanel" class="tab-pane fade" id="edit">
            ...
            <form id="formedit" method="post" action="{{url('foodreviewsedit')}}"  >
                @csrf
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-4">
                        <div class="form-group form-group-lg">
                        <div class="form-line">
                            <select name="food" id="foodEdit" class="form-control bs-searchbox show-tick" style="font-size: 26px  !important; ">
                                <option value="-1" style="font-size: 18px  !important;">{{$lang->get(114)}}</option>
                                @foreach($ifoods as $key => $data)
                                    <option value="{{$data->id}}" style="font-size: 18px  !important;">{{$data->name}}</option>
                                @endforeach
                ...
                <div class="row clearfix">
                    <div class="col-md-2 form-control-label">
                        <label for="name"><h4>{{$lang->get(136)}}</h4></label>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group form-group-lg">
                            <div class="form-line">
                            ...
                            <label class="font-12">{{$lang->get(139)}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    <div class="col-md-12 form-control-label">
                        <div align="center">
                            <button type="submit"  class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(80)}}</h5></button>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function checkFormEdit(event) {
            var alertText = "";
            var sel = document.getElementById("foodEdit");
            if (sel.options[sel.selectedIndex].value == -1){
                alertText = "<h4>{{$lang->get(143)}}</h4>";
            }
        ...
        async function editItem(id, user, food, rate, ckeditor) {
