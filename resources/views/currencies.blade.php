                    ...
                    <div class="col-md-12 foodm">
                        ...
                        <div class="col-md-12 foodm">
                            ...
                            <div class="col-md-3 form-control-label">
                                <div align="center">
                                    <button type="submit" class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(329)}}</h5></button>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12 form-control-label">
                                        <div align="center">
                                            <button type="submit"  class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(339)}}</h5></button>
                                        </div>
                                    </div>
                                </div>
