                ...
                <div class="row clearfix js-sweetalert">
                    ...
                    <div class="col-md-12">
                        <div align="right">
                            ...
                            <button type="button" onclick="selectFood()" class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(186)}}</h5></button>
                            @endif
                        </div>
                    </div>
            ...
            <script>
                function selectFood(){
                    ...
                    @foreach($restaurants as $key => $data)
                        ...
                        text = text + "<td><div onclick=\"addToList({{$data->id}})\" class=\"btn btn-primary waves-effect \"><h5>{{$lang->get(181)}}</h5></div></td></tr>";
                    @endforeach
                        text = text + "                </tbody>\n" +
                        "                </tbody>\n" +
                        "                </table>\n</div></div></div>"
