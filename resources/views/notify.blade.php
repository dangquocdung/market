                ...
                <form id="formcreate" method="post" action="{{url('sendmsg')}}"  >
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 form-control-label">
                            <div align="center">
                                <button type="submit"  class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(291)}}</h5></button>
                            </div>
                        </div>
                    </div>
...
{{--            @include('bsb.image', array('defaultImage' => $defaultImage, 'defaultImageId' => $defaultImageId, 'filesize' => $filesize, 'petani' => $petani))--}}
