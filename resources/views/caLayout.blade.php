        ...
        <script>
            ...
            function appendChildToTable(id, visible){
                if (id == "topf") {
                    ...
                    tr.id = "tr_topf";
                    tr.innerHTML = "                <td><img src=\"img/uitopf.jpg\" width=\"250px\"></td>\n" +
                        "                <td width=\"5%\"></td>\n" +
                        "                <td>\n" +
                        "                    <H5>{{$lang->get(393)}}</H5>\n" +
                        "                    <div id=\"topf\" onclick=\"onCheckClick('topf')\" style=\"font-weight: bold; \"></div>\n" +
                        "                </td>\n" +
                        "                <td width=\"5%\"></td>\n" +
                        "                <td>\n" +
                        "                    <div class=\"btn btn-primary waves-effect\" onclick=\"onUp('tr_topf')\"><i class=\"material-icons\" style=\"font-size: 25px;\">arrow_circle_up</i></div>\n" +
                        "                    <div class=\"btn btn-primary waves-effect\" onclick=\"onDown('tr_topf')\"><i class=\"material-icons\" style=\"font-size: 25px;\">arrow_circle_down</i></div>\n" +
                        "                </td>\n";
                ...
                if (id == "review") {
                    var tr = document.createElement('tr');
                    tr.id = "tr_review";
                    tr.innerHTML = "                <td><img src=\"img/uireview.jpg\" width=\"250px\"></td>\n" +
                        "                <td width=\"5%\"></td>\n" +
                        "                <td>\n" +
                        "                    <H5>{{$lang->get(394)}}</H5>\n" +
                        "                    <div id=\"review\" onclick=\"onCheckClick('review')\" style=\"font-weight: bold; \"></div>\n" +
                        "                </td>\n" +
                        "                <td width=\"5%\"></td>\n" +
                        "                <td>\n" +
                        "                    <div class=\"btn btn-primary waves-effect\" onclick=\"onUp('tr_review')\"><i class=\"material-icons\" style=\"font-size: 25px;\">arrow_circle_up</i></div>\n" +
                        "                    <div class=\"btn btn-primary waves-effect\" onclick=\"onDown('tr_review')\"><i class=\"material-icons\" style=\"font-size: 25px;\">arrow_circle_down</i></div>\n" +
                        "                </td>\n";
                    document.getElementById("tbody").appendChild(tr);
                    if (visible == "true")
                        onCheckClick("review");
                ...
                if (id == "pop") {
                    var tr = document.createElement('tr');
                    tr.id = "tr_pop";
                    tr.innerHTML = "                <td><img src=\"img/uidish.jpg\" width=\"250px\"></td>\n" +
                        "                <td width=\"5%\"></td>\n" +
                        "                <td>\n" +
                        "                    <H5>{{$lang->get(395)}}</H5>\n" +
                        "                    <div id=\"pop\" onclick=\"onCheckClick('pop')\" style=\"font-weight: bold; \"></div>\n" +
                        "                </td>\n" +
                        "                <td width=\"5%\"></td>\n" +
                        "                <td>\n" +
                        "                    <div class=\"btn btn-primary waves-effect\" onclick=\"onUp('tr_pop')\"><i class=\"material-icons\" style=\"font-size: 25px;\">arrow_circle_up</i></div>\n" +
                        "                    <div class=\"btn btn-primary waves-effect\" onclick=\"onDown('tr_pop')\"><i class=\"material-icons\" style=\"font-size: 25px;\">arrow_circle_down</i></div>\n" +
                        "                </td>\n";
                    document.getElementById("tbody").appendChild(tr);
                    if (visible == "true")
                        onCheckClick("pop");
                ...
                if (id == "cat") {
                    var tr = document.createElement('tr');
                    tr.id = "tr_cat";
                    tr.innerHTML = "                <td><img src=\"img/uicat.jpg\" width=\"250px\"></td>\n" +
                        "                <td width=\"5%\"></td>\n" +
                        "                <td>\n" +
                        "                    <H5>{{$lang->get(396)}}</H5>\n" +
                        "                    <div id=\"cat\" onclick=\"onCheckClick('cat')\" style=\"font-weight: bold; \"></div>\n" +
                        "                </td>\n" +
                        "                <td width=\"5%\"></td>\n" +
                        "                <td>\n" +
                        "                    <div class=\"btn btn-primary waves-effect\" onclick=\"onUp('tr_cat')\"><i class=\"material-icons\" style=\"font-size: 25px;\">arrow_circle_up</i></div>\n" +
                        "                    <div class=\"btn btn-primary waves-effect\" onclick=\"onDown('tr_cat')\"><i class=\"material-icons\" style=\"font-size: 25px;\">arrow_circle_down</i></div>\n" +
                        "                </td>\n";
                    document.getElementById("tbody").appendChild(tr);
                    if (visible == "true")
                        onCheckClick("cat");
            ...
            function oneItem(text, id, image){
                return `<td><img src="img/${image}" width="250px"></td>
                        ...
                        <td width="5%"></td>
                        <td>
                            <div class="btn btn-primary waves-effect" onclick="onUp('tr_${id}')"><i class="material-icons" style="font-size: 25px;">arrow_circle_up</i></div>
                            <div class="btn btn-primary waves-effect" onclick="onDown('tr_${id}')"><i class="material-icons" style="font-size: 25px;">arrow_circle_down</i></div>
                        </td>`;
            }
