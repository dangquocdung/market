                                                                ...
                                                                <div class="body">
                                                                    ...
                                                                    <div align="center">
                                                                        ...
                                                                        <button class="btn btn-primary m-t-15 waves-effect"
                                                                            onclick="onAddExtras('{{$data->id}}')"><h5>{{$lang->get(120)}}</h5>
                                                                        </button>
                                                                        @endif
                                                                    </div>
                ...
                <form id="formcreate" method="post" action="{{url('extrasgroupadd')}}"  >
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 form-control-label">
                            <div align="center">
                                <button type="submit"  class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(121)}}</h5></button>
                            </div>
                        </div>
                    </div>
        ...
        <form id="formcreateextras" hidden>
            ...
            <div id="dz1" class="row clearfix">
                <div class="col-md-2 form-control-label">
                    ...
                    <br>
                    <div align="center">
                        <button type="button" onclick="fromLibrary()" class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(77)}}</h5></button>
                    </div>
                </div>
                <div class="col-md-10">
            ...
            <div class="row clearfix">
                <div class="col-md-12 form-control-label">
                    <div align="center">
                        <button type="submit" class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(122)}}</h5></button>
                        <button onclick="onCancelEditExtras()" class="btn btn-primary m-t-15 waves-effect "><h5>Cancel</h5></button>
                    </div>
                </div>
            </div>
