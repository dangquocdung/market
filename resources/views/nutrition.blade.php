                ...
                <form id="formcreate" method="post" action="{{url('nutritiongroupadd')}}"  >
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 form-control-label">
                            <div align="center">
                                <button type="submit"  class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(128)}}</h5></button>
                            </div>
                        </div>
                    </div>
                </form>
...
<div id="formparent" hidden>
    <form id="formcreateextras" hidden>
        ...
        <div class="row clearfix">
            <div class="col-md-12 form-control-label">
                <div align="center">
                    <button type="submit" class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(130)}}</h5></button>
                    <button onclick="onCancelEditExtras()" class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(131)}}</h5></button>
                </div>
            </div>
        </div>
