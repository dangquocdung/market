            ...
            <div role="tabpanel" class="tab-pane fade" id="create">
                ...
                <div id="form" class="row clearfix">
                    ...
                    <div class="col-md-12 foodm">
                        ...
                        <div class="col-md-12 foodm">
                            <div class="col-md-2 foodm">
                                <h4 align="right">{{$lang->get(257)}}: <span class="col-red">*</span></h4>      <!--"Discount",-->
                            </div>
                            <div class="col-md-2 foodm">
                                <div class="form-group form-group-lg form-float">
                                    <div class="form-line">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 form-control-label">
                            <hr>
                            <div align="center">
                                <button type="button" onclick="save();" class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(270)}}</h5></button>
                            </div>
                        </div>
                    </div>
